...
$password = $_POST['password'];
	...
	$loginQuerry = "select * from hosp_regis where username = '$username' and password = '$password'";
	...
	if($count == 1){ 
		...
		function myURL() {
		   document.location.href = 'hospdash.php';
		...
		$sql="SELECT id FROM hosp_regis WHERE username='$username' and password='$password'";
