...
<body>
    <h1 class = "companyName">Hospital Name</h1>
    <div class="search">
            <form action="#">
                <input type="text"
                    placeholder=" Search"
...
<div id="center">
<div id="center-set">
<h1 align='center'><?php echo $loggedin_organization_name; ?></h1>
<!-- You are now logged in. you can logout by clicking on signout link given below. -->
<div id="contentbox">
<?php
$sql="SELECT * FROM hosp_regis where id=$loggedin_id";
...
<td class="tl-4"><?php echo $rows['hospitalname']; ?></td>
<!-- </tr> -->
<!-- <tr id="lg-1"> -->
<td class="tl-1"><div align="left" id="tb-name">Email id:</div></td>
<td class="tl-4"><?php echo $rows['nodalpersonemailid']; ?></td>
</tr>
</table>
